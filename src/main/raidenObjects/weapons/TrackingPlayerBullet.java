 ...
 * When no target is found, it simply flies at preset angle (controlled by {@link main.motionControllers.ConstSpeedXYTargetAwareMotionController}).
 * When a target is given, it tracks the target in full speed (controlled by {@link ConstSpeedTargetTrackingMotionController}).
 *
 * @see main.raidenObjects.aircrafts.shootingAircrafts.PlayerAircraft.TrackingBulletLaunchController
 *
 * @author 蔡辉宇
 */
